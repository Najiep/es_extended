...
CREATE TABLE `users` (
	...
	`gang` VARCHAR(50) NULL DEFAULT 'nogang',
...
INSERT INTO `gang_grades` (`gang_name`, `grade`, `name`, `label`) VALUES ('nogang', 0, 'nogang', 'No Gang');
...
INSERT INTO `gangs` (`name`, `label`) VALUES ('nogang', 'No Gang');
